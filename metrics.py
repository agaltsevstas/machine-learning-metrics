...
# Площадь объединения предсказанных блоков
...
# Площадь пересечения предсказанных блоков
def union(a, b):
    x = min(a[0], b[0])
    y = min(a[1], b[1])
...
def iou(o1, o2, T=0.7):
    """
    Cоотношение площадей между пересечением и объединением предсказанных блоков.
